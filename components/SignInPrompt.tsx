    ...
    <div className="mx-auto max-w-lg px-4 py-24 text-center">
      ...
      {configured ? (
        <>
          ...
          <a
            href="/api/auth/login"
            className="mt-6 inline-flex items-center gap-2 bg-accent px-5 py-2.5 text-sm font-medium text-accent-fg transition-colors hover:bg-accent-hover"
          >
        ...
        <>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-6 inline-block border border-border bg-surface px-5 py-2.5 text-sm font-medium transition-colors hover:border-border-strong"
          >
            Open the repository
          </a>
        </>
